...
INSERT OR REPLACE INTO users (id, username, password_hash, email, avatar, role, badge, rating)
VALUES
...
-- Contests
INSERT OR REPLACE INTO contests (id, title, description, start_time, end_time, type, password, created_by)
VALUES
...
INSERT OR REPLACE INTO contest_problems (id, contest_id, problem_id, display_id)
VALUES
  (1, 1, 1000, 'A'),
  (2, 1, 1001, 'B'),
  (3, 1, 1002, 'C'),
